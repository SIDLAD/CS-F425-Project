...
import os
import pandas as pd
from training_code import AlexAudio, AudioDataset as AD,transformations,BATCH_SIZE,device
import torch
...
OUTPUT_CSV_ABSOLUTE_PATH = "tempfolder/outputput.putput"
...
state_dict = torch.load('epoch60.pth')
model = AlexAudio()
